...
vehicle(licenseplate,model,dateofpurchase,lastrecordedmileage,make,typeoflastservice,dateOfLastService,yearManufactured,serviceCenterId) values('XYZ-5643', 'Civic', '2009-12-24',90452,'Honda',3,'2018-09-10',2009,1);
vehicle(licenseplate,model,dateofpurchase,lastrecordedmileage,make,typeoflastservice,dateOfLastService,yearManufactured,serviceCenterId) values('AHS-3132', 'Prius', '2011-01-02',65452,'Toyota',6,'2018-08-06',2007,1);
vehicle(licenseplate,model,dateofpurchase,lastrecordedmileage,make,typeoflastservice,dateOfLastService,yearManufactured,serviceCenterId) values('IRM-1212', 'Altima', '2002-09-07',210452,'Nissan','1','2018-02-11',2001,1);
vehicle(licenseplate,model,dateofpurchase,lastrecordedmileage,make,typeoflastservice,dateOfLastService,yearManufactured,serviceCenterId) values('TSW-3462', 'Accord', '2015-12-9',null,'Honda',null,null,2015,1);
vehicle(licenseplate,model,dateofpurchase,lastrecordedmileage,make,typeoflastservice,dateOfLastService,yearManufactured,serviceCenterId) values('DEL-8888', 'Rogue', '2016-05-11',31209,'Nissan','1','2018-02-11',2014,1);
vehicle(licenseplate,model,dateofpurchase,lastrecordedmileage,make,typeoflastservice,dateOfLastService,yearManufactured,serviceCenterId) values('P11-212A', 'Accord', '2010-04-14',60452,'Honda','2','2017-09-01',2009,2);
vehicle(licenseplate,model,dateofpurchase,lastrecordedmileage,make,typeoflastservice,dateOfLastService,yearManufactured,serviceCenterId) values('WIM-BLE5', 'Prius', '2014-03-01',19876,'Toyota','1','2016-11-11',2013,2);
